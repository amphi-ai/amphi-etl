...
import {
  ...
  Switch, AutoColumnPosition, ChartGenerator, ComponentsList, MarkdownTools, TableToMarkdown,AddMarkdownStyle,ValidateMarkdown
} from './components';
...
export {
  ...
  Switch, CorrelationMatrix, AutoColumnPosition, ChartGenerator,ComponentsList, MarkdownTools, TableToMarkdown,AddMarkdownStyle,ValidateMarkdown
}
