...
export class Expressions extends PipelineComponent<ComponentItem>() {

  public _name = "Expressions";
  public _id = "expressions";
  ...
  return (
    <>
      {renderComponentUI({
        ...
        ConfigForm: Expressions.ConfigForm({nodeId:id, data, context, componentService, manager, commands, store, setNodes}),
        Icon: Expressions.Icon,
