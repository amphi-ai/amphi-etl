...
export class JsonRange extends PipelineComponent<ComponentItem>() {
        ...
        return (
            <>
                {renderComponentUI({
                    ...
                    commands: commands,
                    name: JsonRange.Name,
                    ConfigForm: JsonRange.ConfigForm,
                    configFormProps: {
                        nodeId: id,
                        data,
                        context,
                ...
                {(showContent || isSelected) && (
                    <NodeToolbar isVisible position={Position.Bottom}>
                        ...
                        {(JsonRange.Type.includes('input') || JsonRange.Type.includes('processor') || JsonRange.Type.includes('output')) && (
