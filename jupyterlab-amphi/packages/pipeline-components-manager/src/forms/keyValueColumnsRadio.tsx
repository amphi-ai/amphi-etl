...
import { ConfigProvider, Divider, Input, Select, Space, Button, Form, Empty, Flex, Radio } from 'antd';
...
export const KeyValueColumnsRadio: React.FC<KeyValueFormProps> = ({ field, handleChange, initialValues, context, componentService, commands, nodeId, advanced }) => {
            ...
            {keyValuePairs.map((pair, index) => (
              <Space direction="vertical" style={{ display: 'flex', width: '100%', marginBottom: 8 }}>
                ...
                <Flex vertical gap="middle">
                  <Radio.Group
                  value={pair.value}
                  onChange={(e: any) => handleChangeKV(e.target.value, index, 'value')} 
                  buttonStyle="solid">
